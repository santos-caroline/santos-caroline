<h3>✨ Estou em transição de carreira para a área de desenvolvimento de software, algo que sempre despertou minha curiosidade e interesse.
Atualmente curso Tecnologia da Informação pela UNIVESP e venho me dedicando aos estudos de lógica de programação, começando com Python e agora me aventurando em Java.

Minha meta atual é aprimorar minha lógica através da prática e, em um futuro próximo, desenvolver habilidades na criação de APIs e no trabalho com bancos de dados
<div></div> Sejam bem-vindos ao meu registro de aprendizagem!
Fiquem à vontade para deixar dicas e sugestões construtivas — serão muito bem-vindas! ✨<h3></h3> 
...
<picture>
  ...
  <img alt="pacman contribution graph" src="https://raw.githubusercontent.com/santos-caroline/santos-caroline/output/pacman-contribution-graph.svg">
</picture>
